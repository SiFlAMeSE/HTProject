...
class TabRowBuild extends Component {
    ...
    toggle() {
        ...
        axios.get('http://128.199.217.17/sensers/senser/' + this.props.obj._id)
            .then(response => {
                this.setState({
    ...
    Deletesenser() {
        axios.post('http://128.199.217.17/sensers/Removesenser/' + this.props.obj._id)
            .then((res) => {
    ...
    UpdateSenser(e) {
        ...
        axios.post('http://128.199.217.17/sensers/update/' + this.props.obj._id, obj)
            .then((res) => {
                if (res.data === 'Updated!') {
