...
export default class set_detail extends React.Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://178.128.48.132:5000/sensers/add', Senser)
            .then((res) => {
        ...
        axios.post('http://178.128.48.132:5000/authorize/add', Authorize)
            .then((res) => {
                if (res.data === 'Server added successfully') {
                    window.location.reload()
                }
    ...
    componentDidMount() {
        ...
        axios.get('http://178.128.48.132:5000/imageupload/picmap/' + this.props.match.params.idmap)
            .then(res => {
                this.setState({
                    Picturemap: res.data
                });
