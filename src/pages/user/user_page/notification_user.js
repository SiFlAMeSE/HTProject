...
class notification extends Component {
    ...
    componentDidMount() {
        axios.get('http://178.128.48.132:5000/WarnTempHumid')
            .then(response => {
        ...
        axios.get('http://178.128.48.132:5000/WarnSenser')
            .then(response => {
        ...
        axios.get('http://178.128.48.132:5000/authorize/authorize_list')
            .then(response => {
        ...
        axios.get('http://178.128.48.132:5000/sensers/senser_list')
            .then(response => {
        ...
        axios.get('http://178.128.48.132:5000/build/build_list')
            .then(response => {
                Build = response.data;
    ...
    sentid = (e) => {
        window.location.replace('/user/notification/' + mac + '/' + s_error + '/' + t + '/' + h + '/' + date)
    }
